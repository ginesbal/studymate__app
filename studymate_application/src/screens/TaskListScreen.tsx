    ...
    <TouchableOpacity
      ...
      <View
        ...
        <View style={styles.taskContent}>
          <View
            style={[styles.dateCircle, {backgroundColor: theme.primaryColor}]}>
            <Text style={[styles.dateText, {color: theme.buttonTextColor}]}>
          ...
          <View>
            ...
            <Text style={[styles.taskSubtitle, {color: theme.textColor}]}>
              {item.description}
            </Text>
          </View>
          <TouchableOpacity
          ...
          <TouchableOpacity
            ...
            <Text
              style={[styles.deleteButtonText, {color: theme.buttonTextColor}]}>
              Delete
            </Text>
          </TouchableOpacity>
        </View>
    ...
    <View style={[styles.container, {backgroundColor: theme.backgroundColor}]}>
      ...
      <View style={styles.headerContainer}>
        ...
        <TouchableOpacity
          ...
          style={[styles.todayButton, {backgroundColor: theme.primaryColor}]}>
          <Text style={[styles.todayText, {color: theme.buttonTextColor}]}>
            Select Date
          </Text>
        </TouchableOpacity>
      </View>
      <View style={styles.filterContainer}>
        ...
        <View style={styles.filterButtons}>
          <TouchableOpacity
            ...
            <Text
              style={[styles.filterButtonText, {color: theme.buttonTextColor}]}>
              All
            </Text>
          </TouchableOpacity>
          <TouchableOpacity
        ...
        {Array.from({length: 7}).map((_, index) => {
          ...
          return (
            <TouchableOpacity
              ...
              <Text style={[styles.dayLabel, {color: theme.textColor}]}>
                {getDayOfWeek(dateString).charAt(0)}
              </Text>
              <Text
                style={[
                  styles.dateLabel,
